...
<body>
    ...
    <div class="menu">
        <select onchange="location = this.value;">
            ...
            <option value="prestamos.php">Prestamos</option>
        </select>
            ...
            if ($response === FALSE) {
                ...
                if (!empty($socios)) {
                    ...
                    foreach ($socios as $socio) {
                        ...
                        echo '<td>
                        <form method="post" action="socios.php" onsubmit="return confirm(\'¿Estás seguro de que quieres eliminar este socio?\');" style="display:inline;">
